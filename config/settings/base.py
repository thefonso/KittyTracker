"""
Base settings for KittyTracker project.
...
LOCAL_APPS = [
    # custom users app
    'kittytracker.users.apps.UsersConfig',
    # Your stuff: custom apps go here
    'kittytracker.tracker'
]
...
CORS_ORIGIN_WHITELIST = (
    'localhost:8000', 'localhost:8080', 'localhost:8081', 'localhost:3000', 'https://kittytracker.herokuapp.com/'
)

# MIGRATIONS CONFIGURATION
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'kittytracker.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Miller Hooks""", 'miller@nicehou.se'),
]
...
ACCOUNT_ADAPTER = 'kittytracker.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'kittytracker.users.adapters.SocialAccountAdapter'
