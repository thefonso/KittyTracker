<template>
  <div class="container-fluid">
    <breadcrumb>
      <breadcrumb-item>
        <router-link to="/">Breadcrumb 1</router-link>
      </breadcrumb-item>
      <breadcrumb-item>
        <router-link to="/">Breadcrumb 2</router-link>
      </breadcrumb-item>
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="typo-line">
              <h2><p class="category">Small Tag</p>header with small subcard-title <br><small>".small" is a tag for the headers</small> </h2>
            </div>
